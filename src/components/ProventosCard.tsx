  ...
  return (
    <div className="bg-white rounded-lg shadow overflow-hidden">
      ...
      <div className="flex justify-end gap-3">
        <button onClick={() => { setSalario(''); setExtra(''); setOutros(''); }} className="px-4 py-2 rounded-lg border cursor-pointer">{t('incomeClear')}</button>
        <button onClick={() => save()} className="px-4 py-2 rounded-lg bg-emerald-600 text-white font-semibold cursor-pointer">{t('incomeSave')}</button>
      </div>
        </div>
      </div>
    </div>
